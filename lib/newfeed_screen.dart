...
// The exception may contain non-JSON text.
    ...
    if (searchable.contains(
      ...
      mappedMessage =
      'Railway Variables ထဲမှာ OPENROUTER_API_KEY မရှိပါ။ Key ထည့်ပြီး Redeploy လုပ်ပါ။';
    } else if (searchable.contains(
      ...
      mappedMessage =
      'OpenRouter account သို့မဟုတ် API key မှာ credit မရှိပါ။ OPENROUTER_VISION_MODEL ကို openrouter/free ထားထားကြောင်း ပြန်စစ်ပါ။';
    } else if (searchable.contains(
      ...
      mappedMessage =
      'Backend မှ OpenRouter ကို ဆက်သွယ်၍မရပါ။ Internet သို့မဟုတ် service connection ကို ပြန်စစ်ပါ။';
    } else if (searchable.contains(
      'pet_image_required',
    )) {
      mappedMessage =
