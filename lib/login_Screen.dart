import 'package:biopet/screens/admin/admin_business_list_screen.dart';
...
// ------------------ BUSINESS OWNER ------------------
        if (_role == "business_owner") {
          ...
          final business = user["businessProfile"] ?? {};

          final bool agreementAccepted =
              business["agreementAccepted"] ?? false;
          ...
          if (latitude == null) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (_) => const BusinessLocationScreen(),
              ),
            );
          ...
          if (status == "draft") {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (_) => const BusinessSubmitScreen(),
              ),
            );
