...
const {
  ...
  "../services/ruleBasedModeration"
);

const {
  moderatePetImages,
} = require(
  "../services/imagePetModeration"
);
...
const createPost = async (
  ...
  try {
   ...
   if (req.files && req.files.length > 0) {
      ...
      if (
        ...
        return res
          ...
          .json({
            ...
            message:
              moderationUnavailable
                ? "ပုံကို စစ်ဆေး၍မရသေးပါ။ ခဏနေ ပြန်တင်ကြည့်ပါ။"
    ...
    // =====================================================
    // CONVERT APPROVED IMAGES TO BASE64
    // =====================================================
    ...
    // =====================================================
        ...
        // if (cleanText !== "") {
        //   console.log(
        //     "CHECKING POST TEXT WITH OPENAI..."
        //   );

        //   aiResult =
        //     await moderatePetPost(
        //       cleanText
        //     );
